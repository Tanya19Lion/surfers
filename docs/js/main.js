$(function(){
    ...
    $('.header_box_tab_last .tab').on('click', function(event) {
        var id = $(this).attr('data-id');
            $('.header_box_tab_last').find('.tab-item').removeClass('active-tab').hide();
            $('.header_box_tab_last .tabs').find('.tab').removeClass('active');
            $(this).addClass('active');
            $('#'+id).addClass('active-tab').fadeIn();
            return false;
    });
    ...
    $(".header_menu_list_menu").on("click", function(){
